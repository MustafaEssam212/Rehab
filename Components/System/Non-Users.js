...
import { FaCirclePlus, FaCircleInfo, FaUserXmark } from "react-icons/fa6";
...
const NonUsers = () => {
    ...
    return(
        <div className="non-users-component-erp">
            <Search sendDataToParent={sendDataToParent} reload={reload} section={`non-users`} />
            {openPopPackage && <PopPackage type="non-user" sendDataToParent={getDataFromPopPackage} section={popPackageSecion} user={user} />}
