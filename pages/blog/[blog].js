...
import BlogOneImage from '../../public/blog1.png';
...
export async function getServerSideProps(context) {
    ...
    const getData = (param) => {
      switch (param) {
        case 'تأهييل حالات العظام والعمود الفقري':
          return {
            title: 'تأهييل حالات العظام والعمود الفقري',
            sections: [
              {
                header: 'مقدمة',
        ...
        case 'تأهييل حالات الأعصاب والشلل بأنواعه':
          return {
            title: 'تأهييل حالات الأعصاب والشلل بأنواعه',
            sections: [
              {
                header: 'مقدمة',
...
const BlogPost = ({ data }) => {
    ...
    const imgs = {
        'تأهييل حالات العظام والعمود الفقري': BlogOneImage.src,
        'تأهييل حالات الأعصاب والشلل بأنواعه': BlogTwoImage.src,
        'قسم السمنة وتنسيق القوام': BlogThreeImage.src
    }
                    ...
                    <div className="recent-blogs">
                        ...
                        <div className="blog">
                            ...
                            <div className="blog-info">
                             <Link href="/blog/قسم_السمنة_وتنسيق_القوام" title="قسم السمنة وتنسيق القوام">قسم السمنة وتنسيق القوام</Link>
                        ...
                        <div className="blog">
                            ...
                            <div className="blog-info">
                             <Link href="/blog/تأهييل_حالات_الأعصاب_والشلل_بأنواعه" title="تأهييل حالات الأعصاب والشلل بأنواعه">تأهييل حالات الاعصاب والشلل بأنواعه</Link>
                             <div className="bottom-blog-info">
                                <p><FaUserDoctor className="icon" />مسؤول</p>
                                <p><FaCalendar className="icon" /> 21-7-2024</p>
                             </div>
                        ...
                        <div className="blog">
                            ...
                            <div className="blog-info">
                             <Link href={`/blog/تأهييل_حالات_العظام_والعمود_الفقري`} title="تأهييل حالات العظام والعمود الفقري">تأهييل حالات العظام والعمود الفقري</Link>
                             <div className="bottom-blog-info">
                                <p><FaUserDoctor className="icon" />مسؤول</p>
                                <p><FaCalendar className="icon" /> 21-7-2024</p>
                             </div>
