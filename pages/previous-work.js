                            ...
                            filtered.map((e, key) => {
                                return(
                                    ...
                                    <div className="blog-img">
                                        ...
                                        {
                                            e.type === 'صورة' && <Image sizes="(min-width: 2060px) calc(1.7vw + 549px), (min-width: 1720px) calc(4.06vw + 417px), (min-width: 1540px) 400px, (min-width: 1380px) 350px, (min-width: 1120px) calc(13.75vw + 163px), (min-width: 440px) 350px, calc(79.17vw + 18px)" loading="lazy" src={`/api/getImage?method=get-work-image&work=${e.name.replace(/ /g, '_')}&image=${e.pic}`} fill style={{objectFit: 'fill'}} alt={e.name}></Image>
                                        }

                                        {
                                            e.type === 'مجموعة صور' && <Image sizes="(min-width: 2060px) calc(1.7vw + 549px), (min-width: 1720px) calc(4.06vw + 417px), (min-width: 1540px) 400px, (min-width: 1380px) 350px, (min-width: 1120px) calc(13.75vw + 163px), (min-width: 440px) 350px, calc(79.17vw + 18px)" loading="lazy" src={`/api/getImage?method=get-work-image&work=${e.name.replace(/ /g, '_')}&image=${e.gallery[0]}`} fill style={{objectFit: 'fill'}} alt={e.name}></Image>
                                        }


{
                                            e.type === 'فيديو' && <Image sizes="(min-width: 2060px) calc(1.7vw + 549px), (min-width: 1720px) calc(4.06vw + 417px), (min-width: 1540px) 400px, (min-width: 1380px) 350px, (min-width: 1120px) calc(13.75vw + 163px), (min-width: 440px) 350px, calc(79.17vw + 18px)" loading="lazy" src={`/api/getImage?method=get-work-image&work=${e.name.replace(/ /g, '_')}&image=${e.videoThumbnail}`} fill style={{objectFit: 'fill'}} alt={e.name}></Image>
                                        }
