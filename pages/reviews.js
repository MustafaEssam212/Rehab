...
const Reviews = ({data}) => {
    ...
    return(
        <div className="blogs-page-container">
            <NextSeo title={'اراء عملائنا - مركز ريهاب للعلاج الطبيعي والتأهيل'} />
